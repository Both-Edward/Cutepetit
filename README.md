...
Cutepetit 是一个功能丰富的桌面宠物应用程序，为您的 Windows 桌面增添活力和趣味。这个可爱的数字伙伴会在您的桌面上自由活动，响应您的互动，陪您一起听音乐，为您的数字工作空间带来生气。
...
通过右键菜单随时在**简体中文**、**繁體中文**、**English**、**日本語**、**한국어**、**Français** 之间切换。所选语言会自动保存，下次启动恢复。
...
- [x] 国际化（简体中文、繁体中文、英文、日文、韩文、法文）
- [x] LLM Agent（支援OpenAI兼容的API格式）
- [ ] TTS Agent
- [ ] Linux (GTK tray)
